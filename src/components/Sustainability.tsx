...
const Sustainability = () => {
  ...
  return (
    <section id="sustainability" className="py-20 bg-gradient-to-b from-darker-surface to-background">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative animate-fade-in-up">
            <div className="relative overflow-hidden rounded-2xl">
              <img 
                src={sustainabilityTree} 
                alt="Hand holding digital tree representing sustainable technology"
              ...
              {initiatives.map((initiative, index) => {
                ...
                return (
                  <div 
                    ...
                    className="group p-6 bg-card/30 backdrop-blur-sm rounded-xl border border-border/30 hover:border-primary/40 transition-all duration-300 hover:-translate-y-1 animate-fade-in-up"
