...
const CarbonFootprintReduction = () => {
  ...
  const metrics = [
    { label: 'Total Emissions Reduced', value: '2.4M', unit: 'tons CO₂' },
    { label: 'Energy Efficiency Gain', value: '45%', unit: 'improvement' },
    { label: 'Renewable Energy Usage', value: '100%', unit: 'of total power' },
    { label: 'Carbon Intensity', value: '0.12', unit: 'kg CO₂/kWh' }
  ];

  const timeline = [
    { year: '2020', milestone: 'Baseline Assessment', description: 'Comprehensive carbon footprint analysis', status: 'completed' },
    { year: '2021', milestone: '25% Reduction', description: 'Initial efficiency improvements implemented', status: 'completed' },
    { year: '2022', milestone: '50% Reduction', description: 'Renewable energy transition begins', status: 'completed' },
    { year: '2023', milestone: '75% Reduction', description: 'Advanced optimization systems deployed', status: 'completed' },
    { year: '2024', milestone: 'Carbon Neutral', description: 'Net-zero operational emissions achieved', status: 'in-progress' },
    { year: '2025', milestone: 'Carbon Negative', description: 'Remove more carbon than we produce', status: 'planned' }
  ];
      ...
      <main>
          ...
          <div className="section-container">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {reductionStrategies.map((strategy, index) => {
                ...
                return (
                  <Card key={strategy.title} className="group hover:shadow-lg transition-all duration-300">
                    <CardHeader>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {timeline.map((item, index) => (
                <Card key={item.year} className={`relative overflow-hidden ${
                  ...
                  item.status === 'in-progress' ? 'border-yellow-500/50' : 'border-muted'
                }`}>
        ...
        <section className="py-16 bg-gradient-to-r from-green-500/10 to-blue-500/10">
          <div className="section-container text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Partner with <span className="gradient-text">Carbon Leaders</span>
            </h2>
            <p className="text-lg text-foreground/70 mb-8 max-w-2xl mx-auto">
              Join the next generation of sustainable data centers that prove environmental 
              responsibility and operational excellence can coexist.
            </p>
            <button className="btn-neon">
              View Our Carbon Report
            </button>
          </div>
        </section>
      </main>
